          ...
          <div className="glass-card p-12 md:p-16 rounded-3xl text-center space-y-8">
            <div className="space-y-4">
              <h2 className="text-4xl md:text-6xl font-bold">
                <span className="glow-cyan">Ready to Transform</span>
                <br />
                <span className="glow-purple">Your Business?</span>
              </h2>
            ...
            <div className="pt-8 border-t border-border/50">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                <div>
                  <div className="text-2xl font-bold glow-cyan mb-1">24/7</div>
                  <div className="text-sm text-muted-foreground">Support</div>
                </div>
                <div>
                  <div className="text-2xl font-bold glow-purple mb-1">Global</div>
                  <div className="text-sm text-muted-foreground">Coverage</div>
                </div>
                <div>
                  <div className="text-2xl font-bold glow-cyan mb-1">Instant</div>
